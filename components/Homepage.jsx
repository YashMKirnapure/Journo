        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-orange-400" />
                <span>Pattern recognitions</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="mt-24">
        <Card className='bg-gradient-to-r from-orange-100 to-amber-100'>
          <CardContent className='p-12 text-center'>
            <h2 className="text-3xl text-orange-900 mb-6 font-bold">Start reflecting on your journey today</h2>
            <p className="text-lg text-orange-700 mb-8 max-w-2xl mx-auto">Join thousands of writers who have already discovered the power of digital journaling</p>
            <Link href="/dashboard">
